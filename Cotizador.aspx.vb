...
Partial Class Pages_Cotizador
    Inherits System.Web.UI.Page

    Private Sub Pages_Cotizador_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim Scripts As String = ""

        Dim Random1 As New Random()
        Dim Random As Integer = 0
        Dim Debuguear As Boolean = ConfigurationManager.AppSettings("Bandera").ToString()
        ...
        Scripts &= "<meta http-equiv='Content-Type' content='text/html; charset=ISO-8859-1'>"
        ...
        Scripts &= "<link href='../Styles/ANA/jquery-ui-1.10.4.custom.css?" & Random & "' rel='stylesheet' type='text/css' />"
        ...
        Scripts &= "<script src='../Scripts/Cotizador.js?" & Random & "' type='text/javascript'></script>"


        Scripts &= "<script type='text/javascript'>"
        Scripts &= "    $(document).ready(function () {Cotizador.Iniciar('dcadb3e5371e4c2da031a606e26cf60b', 0);});"
        Scripts &= "</script>"

        HeadCotizador.InnerHtml = Scripts
    End Sub
End Class
